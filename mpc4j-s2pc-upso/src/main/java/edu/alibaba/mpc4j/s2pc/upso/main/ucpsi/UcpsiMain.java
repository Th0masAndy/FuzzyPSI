...
public class UcpsiMain {
    ...
    private void runServer(Rpc serverRpc, Party clientParty, UcpsiConfig config, int taskId,
        ...
        String info = ucpsiServer.ownParty().getPartyId()
            ...
            + "\t" + silent
            + "\t" + initTime + "\t" + initDataPacketNum + "\t" + initPayloadByteLength * 1.0 / (1 << 20) + "\t" + initSendByteLength * 1.0 / (1 << 20)
            + "\t" + ptoTime + "\t" + ptoDataPacketNum + "\t" + ptoPayloadByteLength * 1.0 / (1 << 20) + "\t" + ptoSendByteLength * 1.0 / (1 << 20);
